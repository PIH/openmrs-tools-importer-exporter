...
export default {
  SOURCE: {
    URLS: {
      ...
      MEDICATION_DISPENSE: `${config.OPENMRS_SOURCE_CONTEXT_PATH}/ws/fhir2/R4/MedicationDispense`,
  ...
  TARGET: {
    URLS: {
      ...
      MEDICATION_DISPENSE: `${config.OPENMRS_TARGET_CONTEXT_PATH}/ws/fhir2/R4/MedicationDispense`,
