...
const PERSON_REP = `(uuid,gender,birthdate,birthdateEstimated,dead,deathDate,causeOfDeath,names:(uuid,givenName,familyName,familyName2,middleName,voided),addresses,attributes:(uuid,value,attributeType:(uuid)))`
...
export default {
  ...
  PATIENT_CUSTOM_REP: `v=custom:(uuid,display,identifiers:(uuid,identifier,identifierType:(uuid),preferred),person:${PERSON_REP})`,
