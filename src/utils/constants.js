...
export default {
  ...
  USER_CUSTOM_REP: `v=custom:(uuid,username,email,userProperties,retired,retiredBy,retireReason,roles:(uuid),person:${PERSON_REP},dateCreated,creator:(uuid))`,  // NOTE: we don't include date change and changed by for user due to potential circular references
